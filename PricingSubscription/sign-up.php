...
<html>
	<head>
		<title>212 | Pricing Plans and Subscription Payment</title>
		<link rel="icon" href="images/logo4 - Copy.png"/>
	...
	<body>
		...
		<div class="priceing-table w3l">
			<div class="wrap">
				...
				<h3 style="text-align:center;">Payment with paypal<h4><br/>
								...
								<div class="price-gd-bottom">
									<div class="price-list">
										<ul>
											...
											<li>Free Updates</li>
											<li>Unlimited blogspace</li>
											<li>Unlimited promotion & Marketing</li>
		...
		<div class="copy-rights">
			<p>Design by  <a href="http://w3layouts.com/" target="_blank">Ubsimple</a> </p>
		</div>
	</body>
</html>