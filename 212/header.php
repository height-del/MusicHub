			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php">
						<img src="Music Hub/images/logo4 - Copy.png">Music Hub | 212</a>
				</div>
				...
				<div class="col-md-4 log-icons text-right">
					...
					<ul class="social_list1 mt-3">
						...
						<li>
							<a href="https://www.facebook.com/paparazze.akpabio"<?php getlinks("links","facebook");?>" class="facebook1 mx-2" >
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="Music Hub/templated-radius/index.html" target="_blank">212 Music Hub</a>
							</li>
