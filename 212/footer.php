		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 footer-grid-agileits-w3ls text-left">
					...
					<div class="read">
						<a href="about.php" class="btn btn-primary read-m">View More</a>
					</div>
				</div>
				<div class="col-lg-4 footer-grid-agileits-w3ls text-left">
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> Music Hub <?php $current=date("Y"); print_r($current);?> | Brought To You by
						<a href="Music Hub/index.html">212</a>
					</p>
